...
- **Test suite grew from 207 to 218 tests.** The `describe('createErrorAnnotation', ...)` block was rewritten end to end, splitting the single flat block into three nested describe blocks (404, 403, else) with tighter per-branch assertions including chip class, svg presence, aria-label, and tooltip.
